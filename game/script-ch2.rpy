...
label ch2_start:
    ...
    mc "优里。"
    $ y_name = 'Yuri'
    show sayori 4x at h21
    s "哈，太对辣。"
    y "没错…"
    s 2a "优里，介绍一下你自己。"
    show yuri 1c at t22               #t=talk h=horry!!! f=fall
    y "我是三年六班…"
    mc "？"
    show yuri 4c at h22
    y "啊不是（）"
    ...
    menu:
        "去找纱世理":
            jump find_sayori_line
        "留下陪着尤里":
            jump stay_with_yuri_line

    label find_sayori_line:
        "我决定去找纱世理。"
        mc "尤里，你在这里等我一会！"
        y "啊？"
        y 1h "为什么…"
